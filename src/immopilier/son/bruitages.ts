 ...
 *
 * `fichier` vaut `null` tant que le son n'est pas choisi. Les fichiers vont dans
 * `public/son/bruitages/`.
 */
...
export const BRUITAGES: Bruitage[] = [
  {image: 318, role: 'plan 3 — le clac de pause, quand la fenêtre se fige', fichier: null, volume: 0.7},
  {image: 1087, role: 'plan 8 — le souffle montant sur l’arrivée de la marque', fichier: null, volume: 0.5},
  {image: 1309, role: 'plan 8 — le ding propre sur le ✓', fichier: null, volume: 0.8},
  ...
  {image: 3984, role: 'plan 24 — le clic de souris final', fichier: null, volume: 0.9},
];
